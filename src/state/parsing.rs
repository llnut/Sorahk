...
pub fn mouse_move_name_to_direction(name: &str) -> Option<MouseMoveDirection> {
    match name {
        ...
        "MOUSE_RIGHT" | "MOUSERIGHT" | "MOVE_RIGHT" | "M_RIGHT" => Some(MouseMoveDirection::Right),
        ...
        "MOUSE_DOWN_LEFT" | "MOUSEDOWNLEFT" | "M_DOWN_LEFT" => Some(MouseMoveDirection::DownLeft),
...
pub fn mouse_button_name_to_type(name: &str) -> Option<MouseButton> {
    match name {
        ...
        "MBUTTON" | "MMOUSE" | "MIDDLEMOUSE" | "MIDDLEBUTTON" | "MMB" => Some(MouseButton::Middle),
